...
export function BackDrop({ movie, fullWith, biggerText }: BackDropProps) {
    return (
        <div className={`invisible absolute left-0 top-0 z-10 ${fullWith ? 'w-full' : 'w-5/6'} h-full bg-black/80 p-2 text-white backdrop-opacity-100 group-hover:visible rounded-2xl`}>
